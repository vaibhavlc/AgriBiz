...
export const Reports: React.FC = () => {
  ...
  const gstr1DocsSummary = useMemo(() => {
    ...
    if (targetInvoices.length === 0) {
      return { from: 'ΓÇö', to: 'ΓÇö', total: 0, cancelled: 0, netIssued: 0 };
    }
  ...
  const handleExportGstr3B = () => {
    const headers = ['GSTR-3B Table Section', 'Nature of Supplies / Credit', 'Total Taxable Value (Γé╣)', 'Integrated Tax (Γé╣)', 'Central Tax (Γé╣)', 'State/UT Tax (Γé╣)', 'Cess (Γé╣)'];
    const rows = [
  ...
  const handleExport = () => {
    ...
    if (activeReport === 'sales') {
      ...
      rows = filteredExpenses.map(exp => [
        ...
        exp.status || 'Paid',
        exp.status === 'Due' ? 'ΓÇö' : exp.paymentMethod,
        exp.status === 'Due' ? 'ΓÇö' : (exp.referenceNumber || 'ΓÇö'),
        exp.notes || 'ΓÇö'
      ]);
    ...
    return (
      <div className="gstr3b-working-report-wrapper">
            ...
            <table className="gstr3b-ca-table">
              <thead>
                <tr>
                  ...
                  <th style={{ textAlign: 'right' }}>Taxable Value (Γé╣)</th>
                  <th style={{ textAlign: 'right' }}>Integrated Tax (Γé╣)</th>
                  <th style={{ textAlign: 'right' }}>Central Tax (Γé╣)</th>
                  <th style={{ textAlign: 'right' }}>State/UT Tax (Γé╣)</th>
                  <th style={{ textAlign: 'right' }}>Cess (Γé╣)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>(a) Outward taxable supplies (other than zero rated, nil rated and exempted)</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(gstr3BData.outward.taxable).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(gstr3BData.outward.igst).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(gstr3BData.outward.cgst).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(gstr3BData.outward.sgst).replace('Γé╣', '')}</td>
            ...
            <table className="gstr3b-ca-table">
              <thead>
                <tr>
                  ...
                  <th style={{ textAlign: 'right' }}>Total Taxable Value (Γé╣)</th>
                  <th style={{ textAlign: 'right' }}>Integrated Tax (Γé╣)</th>
                </tr>
              </thead>
              <tbody>
                {hasInterstateSupplies ? (
                  <>
                    <tr>
                      ...
                      <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(interstateUnregisteredTaxable).replace('Γé╣', '')}</td>
                      <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(interstateUnregisteredIGST).replace('Γé╣', '')}</td>
                    </tr>
                    <tr>
            ...
            <table className="gstr3b-ca-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ textAlign: 'right', fontWeight: 600, fontFamily: 'monospace' }}>{formatINR(gstr3BData.itc.igst).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontWeight: 600, fontFamily: 'monospace' }}>{formatINR(gstr3BData.itc.cgst).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontWeight: 600, fontFamily: 'monospace' }}>{formatINR(gstr3BData.itc.sgst).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>0.00</td>
                </tr>
                <tr style={{ backgroundColor: '#fafbfa', fontWeight: 'bold' }}>
                ...
                <tr className="total-row">
                  ...
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(gstr3BData.itc.igst).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(gstr3BData.itc.cgst).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(gstr3BData.itc.sgst).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>0.00</td>
                </tr>
              </tbody>
            </table>
            ...
            <table className="gstr3b-ca-table">
              <thead>
                <tr>
                  ...
                  <th style={{ textAlign: 'right' }}>Inter-State Supplies (Γé╣)</th>
                  <th style={{ textAlign: 'right' }}>Intra-State Supplies (Γé╣)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
          ...
          <div className="gstr3b-table-scroll-wrapper">
            <table className="gstr3b-ca-table">
              <thead>
                <tr>
                  <th>Tax Component</th>
                  <th style={{ textAlign: 'right' }}>Tax Liability (Γé╣)</th>
                  <th style={{ textAlign: 'right' }}>ITC Utilized (Γé╣)</th>
                  <th style={{ textAlign: 'right' }}>Paid in Cash (Γé╣)</th>
                  <th style={{ textAlign: 'right' }}>Balance Credit (Γé╣)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td style={{ fontWeight: 600 }}>Integrated Tax (IGST)</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(igstLiability).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace', color: '#10b981' }}>{formatINR(igstItcUtilized).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace', color: igstCashPaid > 0 ? '#be3144' : 'inherit' }}>{formatINR(igstCashPaid).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace', color: '#10b981' }}>{formatINR(igstRemainingCredit).replace('Γé╣', '')}</td>
                </tr>
                <tr>
                  <td style={{ fontWeight: 600 }}>Central Tax (CGST)</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(cgstLiability).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace', color: '#10b981' }}>{formatINR(cgstItcUtilized).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace', color: cgstCashPaid > 0 ? '#be3144' : 'inherit' }}>{formatINR(cgstCashPaid).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace', color: '#10b981' }}>{formatINR(cgstRemainingCredit).replace('Γé╣', '')}</td>
                </tr>
                <tr>
                  <td style={{ fontWeight: 600 }}>State/UT Tax (SGST)</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(sgstLiability).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace', color: '#10b981' }}>{formatINR(sgstItcUtilized).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace', color: sgstCashPaid > 0 ? '#be3144' : 'inherit' }}>{formatINR(sgstCashPaid).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace', color: '#10b981' }}>{formatINR(sgstRemainingCredit).replace('Γé╣', '')}</td>
                </tr>
                <tr>
                ...
                <tr className="total-row">
                  ...
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(totalLiability).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(totalItcUtilized).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(totalCashPaid).replace('Γé╣', '')}</td>
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>{formatINR(totalRemainingCredit).replace('Γé╣', '')}</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '30px', fontSize: '9px', color: '#5d6b5e', borderTop: '1px dashed #e2e9e0', paddingTop: '16px' }}>
          <div>System Generated Report ΓÇó AgriBiz Financial Modules</div>
                ...
                <table className="data-table">
                  <thead>
                    <tr>
                      ...
                      <th>Customer Name</th>
                      <th>Date</th>
                      <th style={{ textAlign: 'right' }}>Taxable Amt (Γé╣)</th>
                      <th style={{ textAlign: 'right' }}>Tax collected (Γé╣)</th>
                      <th style={{ textAlign: 'right' }}>Grand Total (Γé╣)</th>
                      <th>Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    {filteredInvoices.map((inv) => (
                      <tr key={inv.id}>
                        ...
                        <td style={{ textAlign: 'right' }}>{formatINR(inv.subtotal - inv.discountTotal).replace('Γé╣', '')}</td>
                        <td style={{ textAlign: 'right' }}>{formatINR(inv.gstTotal).replace('Γé╣', '')}</td>
                        <td style={{ textAlign: 'right', fontWeight: 600 }}>{formatINR(inv.grandTotal).replace('Γé╣', '')}</td>
                        <td>
                    ...
                    <tr style={{ fontWeight: 700, backgroundColor: 'var(--bg-app)' }}>
                      ...
                      <td style={{ textAlign: 'right' }}>{formatINR(totalSalesBase).replace('Γé╣', '')}</td>
                      <td style={{ textAlign: 'right' }}>{formatINR(totalSalesTax).replace('Γé╣', '')}</td>
                      <td style={{ textAlign: 'right' }}>{formatINR(totalSalesVal).replace('Γé╣', '')}</td>
                      <td></td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="data-table">
                  <thead>
                    <tr>
                      ...
                      <th>Supplier Name</th>
                      <th>Receipt Date</th>
                      <th style={{ textAlign: 'right' }}>Base Cost (Γé╣)</th>
                      <th style={{ textAlign: 'right' }}>Tax paid (Γé╣)</th>
                      <th style={{ textAlign: 'right' }}>Total Cost (Γé╣)</th>
                      <th>Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    {filteredPurchases.map((pur) => (
                      <tr key={pur.id}>
                        ...
                        <td style={{ textAlign: 'right' }}>{formatINR(pur.subtotal).replace('Γé╣', '')}</td>
                        <td style={{ textAlign: 'right' }}>{formatINR(pur.gstTotal).replace('Γé╣', '')}</td>
                        <td style={{ textAlign: 'right', fontWeight: 600 }}>{formatINR(pur.grandTotal).replace('Γé╣', '')}</td>
                        <td>
                    ...
                    <tr style={{ fontWeight: 700, backgroundColor: 'var(--bg-app)' }}>
                      <td colSpan={3}>Report Summary Total:</td>
                      <td style={{ textAlign: 'right' }}>{formatINR(totalPurchasesBase).replace('Γé╣', '')}</td>
                      <td style={{ textAlign: 'right' }}>{formatINR(totalPurchasesTax).replace('Γé╣', '')}</td>
                      <td style={{ textAlign: 'right' }}>{formatINR(totalPurchasesVal).replace('Γé╣', '')}</td>
                      <td></td>
                    </tr>
                  </tbody>
                </table>
                  ...
                  <table className="data-table">
                    <thead>
                      <tr>
                        ...
                        <th>Category</th>
                        <th>Payee (Paid To)</th>
                        <th style={{ textAlign: 'right' }}>Amount (Γé╣)</th>
                        <th>Status</th>
                        <th>Method</th>
                        <th>Ref Number</th>
                        <th>Notes</th>
                    ...
                    <tbody>
                      {filteredExpenses.map((exp) => (
                        <tr key={exp.id}>
                          ...
                          <td>{exp.status === 'Due' ? 'ΓÇö' : exp.paymentMethod}</td>
                          <td style={{ fontFamily: 'monospace' }}>{exp.status === 'Due' ? 'ΓÇö' : (exp.referenceNumber || 'ΓÇö')}</td>
                          <td style={{ fontStyle: 'italic', maxWidth: '200px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{exp.notes || 'ΓÇö'}</td>
                        </tr>
                      ))}
                      <tr style={{ fontWeight: 700, backgroundColor: 'var(--bg-app)' }}>
                        <td colSpan={4}>Report Summary Total:</td>
                        <td style={{ textAlign: 'right', color: 'var(--color-danger-dark)' }}>{formatINR(totalExpenses).replace('Γé╣', '')}</td>
                        <td colSpan={4}></td>
                      </tr>
                    </tbody>
                  </table>
                ...
                {filteredExpenses.map((exp) => (
                  <div key={exp.id} className="mobile-list-card" style={{ borderLeftColor: exp.status === 'Due' ? '#D97706' : 'var(--color-danger)' }}>
                    ...
                    <div className="mobile-list-card-row">
                      ...
                      <span className="mobile-list-card-val" style={{ fontStyle: 'italic' }}>{exp.notes || 'ΓÇö'}</span>
                    </div>
                  </div>
                ))}
                  ...
                  <table className="data-table">
                    <thead>
                      <tr>
                        ...
                        <th>Date</th>
                        <th>Customer</th>
                        <th style={{ textAlign: 'right' }}>Taxable Sales (Γé╣)</th>
                        <th style={{ textAlign: 'right' }}>Cost Price (Γé╣)</th>
                        <th style={{ textAlign: 'right' }}>Net Profit (Γé╣)</th>
                    ...
                    <tbody>
                      {filteredInvoices.map((inv) => {
                        ...
                        return (
                          <tr key={inv.id}>
                            ...
                            <td>{formatDate(inv.date)}</td>
                            <td>{inv.customerName}</td>
                            <td style={{ textAlign: 'right' }}>{formatINR(inv.subtotal).replace('Γé╣', '')}</td>
                            <td style={{ textAlign: 'right' }}>{formatINR(invoiceCOGS).replace('Γé╣', '')}</td>
                            <td style={{ textAlign: 'right', fontWeight: 600, color: invProfit >= 0 ? 'var(--color-success-dark)' : 'var(--color-danger-dark)' }}>
                              {formatINR(invProfit).replace('Γé╣', '')}
                            </td>
                      ...
                      <tr style={{ fontWeight: 700, backgroundColor: 'var(--bg-app)' }}>
                        <td colSpan={3}>Report Summary Total:</td>
                        <td style={{ textAlign: 'right' }}>{formatINR(totalSalesBase).replace('Γé╣', '')}</td>
                        <td style={{ textAlign: 'right' }}>{formatINR(coGS).replace('Γé╣', '')}</td>
                        <td style={{ textAlign: 'right', color: 'var(--primary-dark)' }}>{formatINR(grossProfit).replace('Γé╣', '')}</td>
                ...
                <table className="data-table">
                  <thead>
                    <tr>
                      ...
                      <th style={{ textAlign: 'right' }}>Cost Price (Γé╣)</th>
                      <th style={{ textAlign: 'right' }}>Asset Valuation (Γé╣)</th>
                      <th style={{ textAlign: 'right' }}>Retail Rate (Γé╣)</th>
                      <th style={{ textAlign: 'right' }}>Retail Valuation (Γé╣)</th>
                    </tr>
                  </thead>
                  <tbody>
                    {products.map((p) => {
                      ...
                      return (
                        <tr key={p.id}>
                          ...
                          <td style={{ textAlign: 'right' }}>{formatINR(p.purchasePrice).replace('Γé╣', '')}</td>
                          <td style={{ textAlign: 'right', fontWeight: 600 }}>{formatINR(itemAssetVal).replace('Γé╣', '')}</td>
                          <td style={{ textAlign: 'right' }}>{formatINR(p.sellingPrice).replace('Γé╣', '')}</td>
                          <td style={{ textAlign: 'right' }}>{formatINR(itemRetailVal).replace('Γé╣', '')}</td>
                        </tr>
                      );
                    })}
                    <tr style={{ fontWeight: 700, backgroundColor: 'var(--bg-app)' }}>
                      ...
                      <td></td>
                      <td style={{ textAlign: 'right' }}>{formatINR(totalAssetVal).replace('Γé╣', '')}</td>
                      <td></td>
                      <td style={{ textAlign: 'right' }}>{formatINR(totalRetailVal).replace('Γé╣', '')}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                  ...
                  <div key={p.id} className="mobile-list-card">
                    <div className="mobile-list-card-header">
                      <div>
                        ...
                        <span className="mobile-list-card-subtitle">{p.category} ΓÇó SKU: {p.sku}</span>
                      </div>
                    ...
                    <table className="data-table">
                      <thead>
                        <tr>
                          ...
                          <th style={{ textAlign: 'right' }}>Total Tax Liability (Γé╣)</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          ...
                          <td style={{ textAlign: 'right' }}>{formatINR(totalSalesBase).replace('Γé╣', '')}</td>
                          <td style={{ textAlign: 'right' }}>{formatINR(totalCGSTCollected).replace('Γé╣', '')}</td>
                          <td style={{ textAlign: 'right' }}>{formatINR(totalSGSTCollected).replace('Γé╣', '')}</td>
                          <td style={{ textAlign: 'right', fontWeight: 600, color: 'var(--color-success-dark)' }}>
                            {formatINR(totalSalesTax).replace('Γé╣', '')}
                          </td>
                        </tr>
                        <tr style={{ borderBottom: '2px solid var(--border-color)' }}>
                          ...
                          <td style={{ textAlign: 'right' }}>{formatINR(totalPurchasesBase).replace('Γé╣', '')}</td>
                          <td style={{ textAlign: 'right' }}>{formatINR(totalCGSTPaid).replace('Γé╣', '')}</td>
                          <td style={{ textAlign: 'right' }}>{formatINR(totalSGSTPaid).replace('Γé╣', '')}</td>
                          <td style={{ textAlign: 'right', fontWeight: 600, color: 'var(--color-info-dark)' }}>
                            {formatINR(totalPurchasesTax).replace('Γé╣', '')}
                          </td>
                        </tr>
                        <tr style={{ fontWeight: 700, backgroundColor: 'var(--bg-app)' }}>
                          <td colSpan={2}>Net Payable Tax Dues:</td>
                          <td style={{ textAlign: 'right' }}>{formatINR(totalSalesBase - totalPurchasesBase).replace('Γé╣', '')}</td>
                          <td style={{ textAlign: 'right' , color: netGSTDue >= 0 ? 'var(--color-danger)' : 'var(--color-success-dark)' }}>
                            {formatINR(totalCGSTCollected - totalCGSTPaid).replace('Γé╣', '')}
                          </td>
                          <td style={{ textAlign: 'right' , color: netGSTDue >= 0 ? 'var(--color-danger)' : 'var(--color-success-dark)' }}>
                            {formatINR(totalSGSTCollected - totalSGSTPaid).replace('Γé╣', '')}
                          </td>
                          <td style={{ textAlign: 'right' , color: netGSTDue >= 0 ? 'var(--color-danger)' : 'var(--color-success-dark)' }}>
                            {formatINR(netGSTDue).replace('Γé╣', '')}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <table className="data-table">
                  <thead>
                    <tr>
                      ...
                      <th style={{ textAlign: 'right' }}>Outstanding Balance (Γé╣)</th>
                      <th>Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    {customers.map((c) => (
                      <tr key={c.id}>
                        ...
                        <td>{c.phone}</td>
                        <td style={{ fontFamily: 'monospace' }}>{c.gstin || 'ΓÇö'}</td>
                        <td
                          style={{
                            textAlign: 'right',
                            fontWeight: 700,
                ...
                <div key={c.id} className="mobile-list-card">
                  <div className="mobile-list-card-header">
                    <div>
                      ...
                      <span className="mobile-list-card-subtitle">ID: {c.id} ΓÇó {c.phone}</span>
                    </div>
                    <span className={`badge ${c.outstanding === 0 ? 'badge-success' : c.outstanding > 0 ? 'badge-warning' : 'badge-info'}`}>
                      {c.outstanding === 0 ? 'Settled' : c.outstanding > 0 ? 'Dues Pending' : 'Advance Credit'}
                    </span>
                  ...
                  <div className="mobile-list-card-row">
                    ...
                    <span className="mobile-list-card-val" style={{ fontFamily: 'monospace' }}>{c.gstin || 'ΓÇö'}</span>
                  </div>
                  <div className="mobile-list-card-row">
                ...
                <table className="data-table">
                  <thead>
                    <tr>
                      ...
                      <th>Phone / Contact</th>
                      <th>GSTIN Identification</th>
                      <th style={{ textAlign: 'right' }}>Balance Owed (Γé╣)</th>
                      <th>Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    {suppliers.map((s) => (
                      <tr key={s.id}>
                        ...
                        <td>{s.phone}</td>
                        <td style={{ fontFamily: 'monospace' }}>{s.gstin || 'ΓÇö'}</td>
                        <td
                          style={{
                            textAlign: 'right',
                            fontWeight: 700,
                ...
                <div key={s.id} className="mobile-list-card">
                  <div className="mobile-list-card-header">
                    <div>
                      ...
                      <span className="mobile-list-card-subtitle">ID: {s.id} ΓÇó {s.phone}</span>
                    </div>
                  ...
                  <div className="mobile-list-card-row">
                    <span className="mobile-list-card-label">GSTIN</span>
                    <span className="mobile-list-card-val" style={{ fontFamily: 'monospace' }}>{s.gstin || 'ΓÇö'}</span>
                  </div>
                  <div className="mobile-list-card-row">
                      ...
                      {gstr1B2BList.length === 0 ? (
                        ...
                        gstr1B2BList.map((item, idx) => (
                          <tr key={idx}>
                            ...
                            <td className="text-nowrap align-right" style={{ fontWeight: 600 }}>{formatINR(item.invoiceValue).replace('Γé╣', '')}</td>
                            <td className="text-nowrap">{item.pos}</td>
                            <td className="text-nowrap align-center" style={{ fontWeight: 'bold' }}>{item.rate}%</td>
                            <td className="text-nowrap align-right" style={{ fontWeight: 600 }}>{formatINR(item.taxableValue).replace('Γé╣', '')}</td>
                            <td className="text-nowrap align-right" style={{ color: 'var(--text-secondary)' }}>{formatINR(item.cgst).replace('Γé╣', '')}</td>
                            <td className="text-nowrap align-right" style={{ color: 'var(--text-secondary)' }}>{formatINR(item.sgst).replace('Γé╣', '')}</td>
                            <td className="text-nowrap align-right" style={{ color: 'var(--text-secondary)' }}>{formatINR(item.igst).replace('Γé╣', '')}</td>
                          </tr>
                        ))
                      )}
                    </tbody>
                      ...
                      {gstr1B2CSList.length === 0 ? (
                        ...
                        gstr1B2CSList.map((item, idx) => (
                          <tr key={idx}>
                            ...
                            <td className="text-nowrap align-center" style={{ fontWeight: 'bold' }}>{item.rate}%</td>
                            <td className="text-nowrap align-right" style={{ fontWeight: 600 }}>{formatINR(item.taxable).replace('Γé╣', '')}</td>
                            <td className="text-nowrap align-right" style={{ color: 'var(--text-secondary)' }}>{formatINR(item.cgst).replace('Γé╣', '')}</td>
                            <td className="text-nowrap align-right" style={{ color: 'var(--text-secondary)' }}>{formatINR(item.sgst).replace('Γé╣', '')}</td>
                            <td className="text-nowrap align-right" style={{ color: 'var(--text-secondary)' }}>{formatINR(item.igst).replace('Γé╣', '')}</td>
                          </tr>
                      ...
                      {gstr1HSNList.length === 0 ? (
                        ...
                        gstr1HSNList.map((item, idx) => (
                          <tr key={idx}>
                            ...
                            <td className="text-nowrap align-right">{formatINR(item.totalVal).replace('Γé╣', '')}</td>
                            <td className="text-nowrap align-right" style={{ fontWeight: 600 }}>{formatINR(item.taxable).replace('Γé╣', '')}</td>
                            <td className="text-nowrap align-right" style={{ color: 'var(--text-secondary)' }}>{formatINR(item.cgst).replace('Γé╣', '')}</td>
                            <td className="text-nowrap align-right" style={{ color: 'var(--text-secondary)' }}>{formatINR(item.sgst).replace('Γé╣', '')}</td>
                            <td className="text-nowrap align-right" style={{ color: 'var(--text-secondary)' }}>{formatINR(item.igst).replace('Γé╣', '')}</td>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px' }}>
              <thead>
                <tr style={{ backgroundColor: '#2F3E33', color: '#ffffff' }}>
                  ...
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Taxable Amt (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Tax (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Grand Total (Γé╣)</th>
              ...
              <tbody>
                {filteredInvoices.map((inv, idx) => (
                  <tr key={inv.id} style={{ backgroundColor: idx % 2 === 0 ? '#ffffff' : '#F9FAF9' }}>
                    ...
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(inv.subtotal - inv.discountTotal).replace('Γé╣', '')}</td>
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(inv.gstTotal).replace('Γé╣', '')}</td>
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right', fontWeight: 'bold' }}>{formatINR(inv.grandTotal).replace('Γé╣', '')}</td>
                ...
                <tr style={{ fontWeight: 'bold', backgroundColor: '#E2E9E0' }}>
                  ...
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalSalesBase).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalSalesTax).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalSalesVal).replace('Γé╣', '')}</td>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px' }}>
              <thead>
                <tr style={{ backgroundColor: '#2F3E33', color: '#ffffff' }}>
                  ...
                  <th style={{ padding: '6px 8px', textAlign: 'left', border: '1px solid #2F3E33' }}>Date</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Base Cost (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Tax Paid (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Total Cost (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'center', border: '1px solid #2F3E33' }}>Status</th>
                </tr>
              </thead>
              <tbody>
                {filteredPurchases.map((pur, idx) => (
                  <tr key={pur.id} style={{ backgroundColor: idx % 2 === 0 ? '#ffffff' : '#F9FAF9' }}>
                    ...
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(pur.subtotal).replace('Γé╣', '')}</td>
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(pur.gstTotal).replace('Γé╣', '')}</td>
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right', fontWeight: 'bold' }}>{formatINR(pur.grandTotal).replace('Γé╣', '')}</td>
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'center' }}>{pur.paymentStatus}</td>
                  </tr>
                ))}
                <tr style={{ fontWeight: 'bold', backgroundColor: '#E2E9E0' }}>
                  <td colSpan={3} style={{ padding: '8px', border: '1px solid #C8D3C5' }}>Report Summary Total:</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalPurchasesBase).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalPurchasesTax).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalPurchasesVal).replace('Γé╣', '')}</td>
                  <td style={{ border: '1px solid #C8D3C5' }}></td>
                </tr>
              </tbody>
            </table>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px' }}>
              <thead>
                <tr style={{ backgroundColor: '#2F3E33', color: '#ffffff' }}>
                  ...
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Amount (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'center', border: '1px solid #2F3E33' }}>Status</th>
              ...
              <tbody>
                {filteredExpenses.map((exp, idx) => (
                  <tr key={exp.id} style={{ backgroundColor: idx % 2 === 0 ? '#ffffff' : '#F9FAF9' }}>
                    ...
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right', fontWeight: 'bold' }}>{formatINR(exp.amount).replace('Γé╣', '')}</td>
                    ...
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0' }}>{exp.status === 'Due' ? 'ΓÇö' : exp.paymentMethod}</td>
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', fontFamily: 'monospace' }}>{exp.status === 'Due' ? 'ΓÇö' : (exp.referenceNumber || 'ΓÇö')}</td>
                  </tr>
                ))}
                <tr style={{ fontWeight: 'bold', backgroundColor: '#E2E9E0' }}>
                  <td colSpan={4} style={{ padding: '8px', border: '1px solid #C8D3C5' }}>Report Summary Total:</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right', color: 'var(--color-danger-dark)' }}>{formatINR(totalExpenses).replace('Γé╣', '')}</td>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px' }}>
              <thead>
                <tr style={{ backgroundColor: '#2F3E33', color: '#ffffff' }}>
                  ...
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Taxable Sales (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Cost Price (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Net Profit (Γé╣)</th>
              ...
              <tbody>
                {filteredInvoices.map((inv, idx) => {
                  ...
                  return (
                    <tr key={inv.id} style={{ backgroundColor: idx % 2 === 0 ? '#ffffff' : '#F9FAF9' }}>
                      ...
                      <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0' }}>{formatDate(inv.date)}</td>
                      <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0' }}>{inv.customerName}</td>
                      <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(inv.subtotal).replace('Γé╣', '')}</td>
                      <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(invoiceCOGS).replace('Γé╣', '')}</td>
                      <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right', fontWeight: 'bold', color: invProfit >= 0 ? '#27AE60' : '#BE3144' }}>{formatINR(invProfit).replace('Γé╣', '')}</td>
                ...
                <tr style={{ fontWeight: 'bold', backgroundColor: '#E2E9E0' }}>
                  ...
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalSalesBase).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(coGS).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right', color: netProfit >= 0 ? '#27AE60' : '#BE3144' }}>{formatINR(netProfit).replace('Γé╣', '')}</td>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px' }}>
              <thead>
                <tr style={{ backgroundColor: '#2F3E33', color: '#ffffff' }}>
                  ...
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Cost Price (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Asset Value (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Retail Price (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Retail Value (Γé╣)</th>
                </tr>
              </thead>
              <tbody>
                {products.map((p, idx) => {
                  ...
                  return (
                    <tr key={p.id} style={{ backgroundColor: idx % 2 === 0 ? '#ffffff' : '#F9FAF9' }}>
                      ...
                      <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(p.purchasePrice).replace('Γé╣', '')}</td>
                      <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right', fontWeight: 'bold' }}>{formatINR(itemAssetVal).replace('Γé╣', '')}</td>
                      <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(p.sellingPrice).replace('Γé╣', '')}</td>
                      <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(itemRetailVal).replace('Γé╣', '')}</td>
                    </tr>
                  );
                })}
                <tr style={{ fontWeight: 'bold', backgroundColor: '#E2E9E0' }}>
                  ...
                  <td style={{ border: '1px solid #C8D3C5' }}></td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalAssetVal).replace('Γé╣', '')}</td>
                  <td style={{ border: '1px solid #C8D3C5' }}></td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalRetailVal).replace('Γé╣', '')}</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px' }}>
              <thead>
                <tr style={{ backgroundColor: '#2F3E33', color: '#ffffff' }}>
                  ...
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Base Goods Value (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Central GST (CGST) (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>State GST (SGST) (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Total Tax Liability (Γé╣)</th>
                </tr>
              </thead>
              <tbody>
                <tr style={{ backgroundColor: '#ffffff' }}>
                  ...
                  <td style={{ padding: '8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(totalSalesBase).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(totalCGSTCollected).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(totalSGSTCollected).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #E2E9E0', textAlign: 'right', fontWeight: 'bold' }}>{formatINR(totalSalesTax).replace('Γé╣', '')}</td>
                </tr>
                <tr style={{ backgroundColor: '#F9FAF9' }}>
                  ...
                  <td style={{ padding: '8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(totalPurchasesBase).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(totalCGSTPaid).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #E2E9E0', textAlign: 'right' }}>{formatINR(totalSGSTPaid).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #E2E9E0', textAlign: 'right', fontWeight: 'bold' }}>{formatINR(totalPurchasesTax).replace('Γé╣', '')}</td>
                </tr>
                <tr style={{ fontWeight: 'bold', backgroundColor: '#E2E9E0' }}>
                  ...
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalSalesBase - totalPurchasesBase).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalCGSTCollected - totalCGSTPaid).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right' }}>{formatINR(totalSGSTCollected - totalSGSTPaid).replace('Γé╣', '')}</td>
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right', color: netGSTDue >= 0 ? '#BE3144' : '#27AE60' }}>{formatINR(netGSTDue).replace('Γé╣', '')}</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px' }}>
              <thead>
                <tr style={{ backgroundColor: '#2F3E33', color: '#ffffff' }}>
                  ...
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Outstanding (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'center', border: '1px solid #2F3E33' }}>Status</th>
                </tr>
              </thead>
              <tbody>
                {customers.map((c, idx) => (
                  <tr key={c.id} style={{ backgroundColor: idx % 2 === 0 ? '#ffffff' : '#F9FAF9' }}>
                    ...
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', fontFamily: 'monospace' }}>{c.gstin || 'ΓÇö'}</td>
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right', fontWeight: 'bold', color: c.outstanding > 0 ? '#BE3144' : c.outstanding < 0 ? '#27AE60' : 'inherit' }}>{formatINR(c.outstanding).replace('Γé╣', '')}</td>
                ...
                <tr style={{ fontWeight: 'bold', backgroundColor: '#E2E9E0' }}>
                  ...
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right', color: '#BE3144' }}>{formatINR(pendingReceivables).replace('Γé╣', '')}</td>
                  <td style={{ border: '1px solid #C8D3C5' }}></td>
                </tr>
              </tbody>
            </table>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px' }}>
              <thead>
                <tr style={{ backgroundColor: '#2F3E33', color: '#ffffff' }}>
                  ...
                  <th style={{ padding: '6px 8px', textAlign: 'left', border: '1px solid #2F3E33' }}>Phone Number</th>
                  <th style={{ padding: '6px 8px', textAlign: 'left', border: '1px solid #2F3E33' }}>GSTIN</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', border: '1px solid #2F3E33' }}>Balance Owed (Γé╣)</th>
                  <th style={{ padding: '6px 8px', textAlign: 'center', border: '1px solid #2F3E33' }}>Status</th>
                </tr>
              </thead>
              <tbody>
                {suppliers.map((s, idx) => (
                  <tr key={s.id} style={{ backgroundColor: idx % 2 === 0 ? '#ffffff' : '#F9FAF9' }}>
                    ...
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', fontFamily: 'monospace' }}>{s.gstin || 'ΓÇö'}</td>
                    <td style={{ padding: '6px 8px', border: '1px solid #E2E9E0', textAlign: 'right', fontWeight: 'bold', color: s.outstanding > 0 ? '#BE3144' : 'inherit' }}>{formatINR(s.outstanding).replace('Γé╣', '')}</td>
                ...
                <tr style={{ fontWeight: 'bold', backgroundColor: '#E2E9E0' }}>
                  ...
                  <td style={{ padding: '8px', border: '1px solid #C8D3C5', textAlign: 'right', color: '#BE3144' }}>{formatINR(pendingPayables).replace('Γé╣', '')}</td>
                  <td style={{ border: '1px solid #C8D3C5' }}></td>
                </tr>
              </tbody>
            </table>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '9px', marginBottom: '16px' }}>
              <thead>
                <tr style={{ backgroundColor: '#F0F4F1', fontWeight: 'bold' }}>
                  ...
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>Taxable Amt (Γé╣)</th>
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>CGST (Γé╣)</th>
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>SGST (Γé╣)</th>
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>IGST (Γé╣)</th>
                </tr>
              </thead>
              <tbody>
                {gstr1B2BList.length === 0 ? (
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '9px', marginBottom: '16px' }}>
              <thead>
                <tr style={{ backgroundColor: '#F0F4F1', fontWeight: 'bold' }}>
                  ...
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>Taxable Value (Γé╣)</th>
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>CGST Amount (Γé╣)</th>
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>SGST Amount (Γé╣)</th>
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>IGST Amount (Γé╣)</th>
                </tr>
              </thead>
              <tbody>
                {gstr1B2CSList.length === 0 ? (
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '9px', marginBottom: '16px' }}>
              <thead>
                <tr style={{ backgroundColor: '#F0F4F1', fontWeight: 'bold' }}>
                  ...
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>Total Value (Γé╣)</th>
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>Taxable Value (Γé╣)</th>
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>CGST (Γé╣)</th>
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>SGST (Γé╣)</th>
                  <th style={{ padding: '4px 6px', border: '1px solid #C8D3C5', textAlign: 'right' }}>IGST (Γé╣)</th>
